...
namespace ScholarshipPortal.Application.UseCases.Overview;

public sealed class GetPortalOverviewQuery(
    IScholarshipRepository scholarshipRepository,
    IApplicationRepository applicationRepository,
    IReviewRepository reviewRepository)
{
    public async Task<PortalOverviewDto> ExecuteAsync(CancellationToken ct = default)
    {
