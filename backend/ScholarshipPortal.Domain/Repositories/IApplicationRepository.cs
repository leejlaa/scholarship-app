...
public interface IApplicationRepository
{
    ...
    Task<IReadOnlyList<Application>> GetByUserIdAsync(string userId, CancellationToken ct = default);
    Task<IReadOnlyList<Application>> GetByScholarshipIdAsync(int scholarshipId, CancellationToken ct = default);
